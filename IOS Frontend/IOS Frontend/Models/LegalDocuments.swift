...
enum LegalDocuments {
    ...
    static let privacyPolicy = LegalDocument(
        ...
        symbol: "hand.raised",
        summary: "What Repbase stores, and what it does not do with it.",
        body: """
        Effective \(effectiveDate)

        WHAT THIS COVERS

        This policy covers the Repbase iOS app and the Repbase server it talks \
        ...
        Repbase does not track your location in the background or when no \
        session is running.
        ...
        and record your activity in Repbase; you can revoke the permission at \
        ...
        Repbase sends email only when it is part of something you asked for, \
        ...
        Repbase is not intended for children under 13, and accounts should not \
    ...
    static let termsOfService = LegalDocument(
        ...
        symbol: "doc.text",
        summary: "The rules for using Repbase and for posting on it.",
        body: """
        Effective \(effectiveDate)

        AGREEING TO THESE TERMS

        Using Repbase means agreeing to these terms. If you do not agree with \
        ...
        disorders. Repbase is a training app and a place where that content \
        does real damage.
        ...
        Repbase records training, food, and body measurements. It does not give \
        ...
        Repbase is provided as it is, without warranty. It may be unavailable, \
        ...
        them and the new version appears here. Continuing to use Repbase after \
    ...
    static let licence = LegalDocument(
        ...
        symbol: "signature",
        summary: "The licence to use the Repbase app itself.",
        body: """
        Effective \(effectiveDate)
        ...
        licence to use the Repbase app on Apple devices you own or control, as \
        ...
        service, and do not scrape the Repbase service through it.
        ...
        Posting on Repbase is also governed by the Terms of Service, including \
